    ...
    def add_annotation(self):
        ...
        for rect in self.selection_rects:
            try:
                ...
                QMessageBox.warning(self, "Ошибка", f"Ошибка добавления аннотации: {e}")
                continue
    ...
    def update_plot(self, position=None):
        ...
        for rect in self.selection_rects:
            try:
                ...
                QMessageBox.warning(self, "Ошибка", f"Ошибка восстановления выделения: {e}")
                continue
        ...
        if len(self.edf_annotations) == 3:  # Проверяем структуру данных
            ...
            for i in range(len(starts)):
                try:
                    ...
                    QMessageBox.warning(self, "Ошибка", f"Ошибка обработки аннотации {i}: {e}")
                    continue
